...
[![CI](https://img.shields.io/github/workflow/status/theonethread/falkor-auth-server/Falkor%20CI%20-%20Manual "CI")](https://github.com/theonethread/falkor-auth-server/actions "Visit") &nbsp;
...
* `1.0.0-beta.8`
    * [npmjs](https://www.npmjs.com/package/@falkor/falkor-auth-server/v/1.0.0-beta.8 "Visit")
    * [GitHub](https://github.com/theonethread/falkor-auth-server/releases/tag/v1.0.0-beta.8 "Visit")
* `1.0.0-beta.7`
