...
To set up a Fedora-based Nginx webserver using Node.js authentication service you can follow my tutorials in the Hetzner Community:
...
* `1.0.0-beta.4`
    * [npmjs](https://www.npmjs.com/package/@falkor/falkor-auth-server/v/1.0.0-beta.4 "Visit")
    * [GitHub](https://github.com/theonethread/falkor-auth-server/releases/tag/v1.0.0-beta.4 "Visit")
* `1.0.0-beta.0`
